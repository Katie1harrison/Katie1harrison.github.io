...
<!-- Poster images -->
![SULI Research Intern CELS Division](ArgonneSciencePoster_page1.jpg){ width=600px }


### OQI Presentation

Focused on modeling the entanglement of neutrinos using quantum algorithms on near-term noisy quantum computers starting with simulations on Qiskit, and moving on to cloud quantum computers and pulse level systems

- [OQI Presentation](Katie Harrison- OQI Presentation.pptx)
...
- [GRFP Research Proposal](Kaytlin Harrison GRFP Research Proposal.pdf)

### Thoughts on success  

Click below to open the full presentation:

- [Invited class speaker](BNL Presentation 07.09.25 (1).pdf)
